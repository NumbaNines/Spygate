...
def fix_text_colors():
    ...
    content = content.replace('color: #ccc; font-size: 12px;', 'color: #767676; font-family: "Segoe UI", sans-serif; font-size: 12px;')
    content = content.replace('color: #888; font-size: 10px;', 'color: #767676; font-family: "Segoe UI", sans-serif; font-size: 10px;')
    content = content.replace('color: #aaa;', 'color: #767676; font-family: "Segoe UI", sans-serif;')
    content = content.replace('color: #666;', 'color: #767676; font-family: "Segoe UI", sans-serif;')
    
    # Fix header text (larger headers in tabs)
    content = content.replace('color: #1ce783; font-size: 16px; font-weight: bold;', 'color: #ffffff; font-family: "Segoe UI", sans-serif; font-size: 16px; font-weight: bold;')
    content = content.replace('color: white;', 'color: #ffffff; font-family: "Segoe UI", sans-serif;')
    ...
    content = re.sub(r'(font-family: "[^"]+", sans-serif;\s*)+', r'font-family: "Segoe UI", sans-serif; ', content)
