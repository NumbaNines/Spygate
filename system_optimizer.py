...
class SystemOptimizer:
    ...
    def analyze_performance(self, benchmark_data: Dict) -> Dict:
        ...
        if self.gpu_available:
            ...
            if gpu_efficiency < 80:
                analysis["optimization_opportunities"].append("GPU underperforming - check memory fragmentation")
        ...
        if best_model[1]["fps"] < 15:
            analysis["optimization_opportunities"].append("YOLO FPS too low for real-time - consider optimization")
    ...
    def generate_optimization_config(self, analysis: Dict) -> Dict:
        ...
        config = {
            "model_settings": {
                "preferred_yolo_model": analysis["recommended_settings"].get("yolo_model", "yolov8s.pt"),
