...
class ModelTrainer:
    ...
    def __init__(self, data_yaml: str, progress_callback: Callable[[int], None]):
        ...
        if not os.path.exists(self.data_yaml):
            raise FileNotFoundError(f"Data configuration file not found: {self.data_yaml}")
    ...
    def _validate_dataset(self) -> None:
        ...
        try:
            ...
            for dir_name in required_dirs:
                ...
                if not any(
                    f.lower().endswith((".png", ".jpg", ".jpeg")) for f in os.listdir(img_dir)
                ):
                ...
                if not os.path.exists(label_dir):
                    raise FileNotFoundError(f"Required directory not found: {label_dir}")
    ...
    def train(self) -> None:
        ...
        try:
            ...
            metrics = model.val(data=self.data_yaml, split="test")  # Use test split for validation
