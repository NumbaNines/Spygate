...
class HUDDatasetPreparer:
    ...
    def prepare_dataset(self, videos_dir: str, annotations_file: str, split_ratio: Tuple[float, float, float] = (0.7, 0.2, 0.1)):
...
def main():
    ...
    parser.add_argument("--output", type=str, default="spygate/models/yolo11/data",
