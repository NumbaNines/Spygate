...
from simple_clip_detector import SimpleClipDetector, OCRValidationError
...
def test_comprehensive_fix():
    ...
    play_sequence = [
        ...
        {"frame": 2200, "down": 2, "distance": 7, "confidence": 0.9, "raw_ocr_text": "2ND & 7"},  # Down change
    ]
    ...
    detector3.process_frame(3000, {"down": 1, "distance": 10, "confidence": 0.9, "raw_ocr_text": "1ST & 10"})
    ...
    if active_clips:
        print(f"✅ Existing clip extended during OCR failure (end_frame: {active_clips[0].end_frame})")
    ...
    # Create some clips
    detector4.process_frame(4000, {"down": 1, "distance": 10, "confidence": 0.9, "raw_ocr_text": "1ST & 10"})
    detector4.process_frame(4100, {"down": 2, "distance": 7, "confidence": 0.9, "raw_ocr_text": "2ND & 7"})
    ...
    rapid_sequence = [
        ...
        {"frame": 5030, "down": 2, "distance": 7, "confidence": 0.9, "raw_ocr_text": "2ND & 7"},   # 1 second later
        {"frame": 5060, "down": 3, "distance": 4, "confidence": 0.9, "raw_ocr_text": "3RD & 4"},   # 1 second later
    ]
