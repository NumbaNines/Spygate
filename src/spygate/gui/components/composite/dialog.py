...
class Dialog(QDialog, BaseWidget):
    ...
    def __init__(
        ...
        self.buttons = buttons or [DialogButton("OK", "primary"), DialogButton("Cancel", "default")]
        self.layout_config = layout_config or LayoutConfig(margins=(20, 20, 20, 20), spacing=15)
