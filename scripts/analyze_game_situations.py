...
from spygate.visualization.visualization_manager import VisualizationManager, VisualizationConfig, VisualizationMode
...
def analyze_screenshot(image_path: str, analyzer: EnhancedGameAnalyzer, viz_manager: VisualizationManager) -> Dict:
...
def main():
    ...
    parser.add_argument("--output", default="analysis_results", help="Output directory for visualizations")
