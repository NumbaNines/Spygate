...
class HUDAnnotator:
    ...
    def mouse_callback(self, event: int, x: int, y: int, flags: int, param: None):
        ...
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            cv2.rectangle(frame_copy, self.start_point, (x, y), 
                         self.classes[self.current_class], 2)
            ...
            cv2.rectangle(self.current_frame, (x1, y1), (x2, y2),
                         self.classes[self.current_class], 2)
...
def main():
    ...
    parser.add_argument("--output", type=str, default="spygate/models/yolo11/data/annotations.json",
