import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QFileDialog, QPushButton, QMessageBox
...
class DemoWindow(QMainWindow):
    ...
    def open_file(self):
        ...
        if file_path:
            ...
            if not valid:
                QMessageBox.critical(self, "Unsupported Video", f"{error}\n\nPlease use H.264 or H.265 encoded MP4/MOV/AVI files.")
                return
