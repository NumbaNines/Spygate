...
def test_template_shift_tolerance():
    ...
    test_image[center_y:center_y + template.shape[0], 
               center_x:center_x + template.shape[1]] = template
    ...
    for shift in shifts:
        ...
        if shifted_x >= 0 and shifted_x + template.shape[1] < test_size:
            shifted_image[center_y:center_y + template.shape[0], 
                         shifted_x:shifted_x + template.shape[1]] = template
