        ...
        while self.running:
            try:
                ...
                if self.save_video and self.video_writer is None and self.video_path:
                    ...
                    self.video_writer = cv2.VideoWriter(self.video_path, fourcc, 15.0, (width, height))
...
class LiveDetectionGUI(QMainWindow):
    ...
    def on_frame_ready(self, frame, detections, stats):
        ...
        for det in detections['detections']:
            ...
            cv2.rectangle(display_frame, (x1, y1-label_size[1]-10), (x1+label_size[0]+5, y1), color, -1)
            cv2.putText(display_frame, label, (x1+2, y1-5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255,255), 1)
