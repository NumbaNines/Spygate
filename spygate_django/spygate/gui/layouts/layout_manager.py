...
class LayoutManager:
    ...
    def add_layout(self, parent_layout: QLayout, child_layout: QLayout, stretch: int = 0) -> None:
    ...
    def add_to_grid(
        self, widget: QWidget, row: int, col: int, rowspan: int = 1, colspan: int = 1
    ) -> None:
    ...
    @staticmethod
    def create_horizontal(
        parent: Optional[QWidget] = None, config: Optional[LayoutConfig] = None
    ) -> QHBoxLayout:
        """Create a horizontal layout.
