...
from .models import UserMetrics, FeatureUsage, ErrorReport, PerformanceMetric, UsageSession
...
class FeatureUsageAdmin(admin.ModelAdmin):
    list_display = ('user', 'feature_name', 'feature_category', 'usage_count', 'last_used', 'success_rate')
...
class ErrorReportAdmin(admin.ModelAdmin):
    ...
    ordering = ('-timestamp',)
    readonly_fields = ('user', 'release', 'error_level', 'error_message', 'stack_trace', 
...
class UsageSessionAdmin(admin.ModelAdmin):
    ...
    ordering = ('-start_time',)
    readonly_fields = ('user', 'start_time', 'end_time', 'duration', 'ip_address', 
                      'user_agent', 'features_used', 'session_data')
