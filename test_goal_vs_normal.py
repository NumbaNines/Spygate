...
def compare_goal_vs_normal():
    ...
    for down_type in ["1ST", "2ND", "3RD", "4TH"]:
        ...
        if template_path.exists():
            ...
            print(
                f"   ✅ Loaded {down_type}: {templates[down_type].shape[1]}x{templates[down_type].shape[0]}px"
            )
    ...
    if "1ST" in templates and "3RD" in templates:
        ...
        normal_test[
            normal_y : normal_y + templates["1ST"].shape[0],
            normal_x : normal_x + templates["1ST"].shape[1],
        ] = templates["1ST"]
        ...
        if goal_x >= 0:
            goal_test[
                normal_y : normal_y + templates["1ST"].shape[0],
                goal_x : goal_x + templates["1ST"].shape[1],
            ] = templates["1ST"]
