...
class LiveGameAnalyzer:
    ...
    def process_frame(self, frame: np.ndarray) -> Tuple[np.ndarray, Dict]:
        ...
        for det in detections:
            ...
            cv2.putText(vis_frame, f"{label}: {det['confidence']:.2f}", 
...
class VisualizationConfig:
    def __init__(self, show_confidence=True, show_bounding_boxes=True,
                 show_labels=True, show_triangles=True, show_ocr=True,
                 box_thickness=2, font_scale=0.6, font_thickness=2):
