...
class TestGameSituationAnalysis:
    ...
    def _analyze_triangles(self, frame: np.ndarray, 
                         detections: Dict) -> List[Tuple[np.ndarray, Tuple[bool, float]]]:
    ...
    def _run_ocr_analysis(self, frame: np.ndarray, 
                         detections: Dict) -> Dict[str, Dict]:
        ...
        return {
            "down_distance": {
                "text": "1ST & 10",
                "confidence": 0.96,
                "bbox": (120, 110, 200, 140)
            },
            "yard_line": {
                "text": "OWN 25",
                "confidence": 0.94,
                "bbox": (220, 110, 300, 140)
            }
        }
        
    def _extract_game_state(self, detections: Dict,
                          triangle_data: List[Tuple[np.ndarray, Tuple[bool, float]]],
                          ocr_results: Dict[str, Dict]) -> GameState:
