...
from spygate.gui.layouts import LayoutConfig, LayoutManager
...
def test_layout_config_application(layout_manager, container):
    ...
    config = LayoutConfig(
        min_size=(100, 100), max_size=(500, 500), margins=(10, 10, 10, 10), spacing=5
    )
...
def test_layout_config(layout_manager):
    ...
    config = LayoutConfig(
        margins=(10, 10, 10, 10), spacing=5, alignment=Qt.AlignmentFlag.AlignCenter
    )
