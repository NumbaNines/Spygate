        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    logger.warning("⚠️ Neither PaddleOCR nor EasyOCR available, using Tesseract fallback")
    ...
    def extract_text(self, region: np.ndarray) -> str:
        ...
        try:
            ...
            if self.ocr_engine == "paddleocr":
                ...
                import pytesseract
                results = pytesseract.image_to_string(processed, config='--psm 8 -c tessedit_char_whitelist=0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ&:')
                return self._extract_text_from_results(results)
