...
from spygate.ui.components.tutorial_system import TutorialStep, TutorialSystem
...
def tutorial_manager(tmp_path):
    ...
    index = {"tutorials": ["test_tutorial"], "version": "1.0"}
    ...
    tutorial = {
        ...
        "steps": [
            ...
            {"title": "Step 2", "description": "Second step", "target_widget": None},
        ],
    }
