...
def setup_training_environment():
    ...
    train_images = Path("hud_region_training/hud_region_training_8class/datasets_8class/train/images")
    train_labels = Path("hud_region_training/hud_region_training_8class/datasets_8class/train/labels")
...
def create_dataset_yaml():
    ...
    dataset_config = {
        'path': str(Path("hud_region_training/hud_region_training_8class/datasets_8class").absolute()),
        'train': 'train/images',
        'val': 'val/images',
        'nc': 8,
        'names': [
...
def train_8class_model():
    ...
    try:
        ...
        print(f"📁 Results saved to: hud_region_training/hud_region_training_8class/runs/hud_8class_v1")
        print(f"🏆 Best model: hud_region_training/hud_region_training_8class/runs/hud_8class_v1/weights/best.pt")
