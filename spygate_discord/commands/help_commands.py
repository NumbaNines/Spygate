...
class HelpCommands(commands.Cog):
    ...
    def create_utility_help(self):
        ...
        embed.add_field(name="/ping", value="Check bot response time and status", inline=True)

        embed.add_field(name="/stats", value="View usage statistics and performance", inline=True)

        embed.add_field(name="/info", value="Detailed information about SpygateAI", inline=True)

        embed.add_field(name="/system", value="System information (Admin only)", inline=True)

        embed.add_field(name="/feedback", value="Submit feedback or bug reports", inline=True)

        embed.add_field(name="/help", value="This help system", inline=True)
