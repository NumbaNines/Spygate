...
def test_game_state_extraction(game_analyzer, sample_frame, mock_yolo_model, mock_ocr):
    ...
    mock_yolo_model.detect_hud_elements.return_value = [
        ...
        {
            "class_name": "possession_triangle_area",
            "bbox": [400, 10, 450, 40],
            "confidence": 0.92
        },
        {
            "class_name": "territory_triangle_area",
            "bbox": [1500, 10, 1550, 40],
            "confidence": 0.94
        },
        {
            "class_name": "preplay_indicator",
            "bbox": [800, 200, 1000, 250],
            "confidence": 0.88
        }
    ]
