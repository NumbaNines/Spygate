#!/usr/bin/env python3
"""
EXACT Ultra-Fine OCR Training
Perfect architecture match to saved model
"""
...
class CRNN(nn.Module):
    """CRNN model for OCR - EXACT match to saved model"""

    def __init__(self, num_classes, img_height=64, hidden_size=256):
        super(CRNN, self).__init__()

        # CNN feature extractor - EXACT match to saved model
        ...
        # RNN layers - EXACT match (2 layers with dropout)
        self.rnn = nn.LSTM(
            input_size=512,
        ...
        # Output layer - EXACT match (named 'classifier' not 'fc')
...
class UltraFineTuner:
    def __init__(self):
        ...
        print(f"🎯 Ultra-Fine Training Setup (EXACT Architecture)")
    ...
    def load_data(self):
        ...
        char_to_idx = {char: idx for idx, char in enumerate(chars)}  # NO +1 for blank (EXACT match)
