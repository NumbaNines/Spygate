...
def test_with_real_screenshots():
    ...
    test_files = [
        {
            "file": "templates/raw_gameplay/1st_10.png",
            "expected_down": 1,
            "is_goal": False,
            "description": "1st & 10",
        },
        {
            "file": "templates/raw_gameplay/2nd_7.png",
            "expected_down": 2,
            "is_goal": False,
            "description": "2nd & 7",
        },
        {
            "file": "templates/raw_gameplay/2nd_10.png",
            "expected_down": 2,
            "is_goal": False,
            "description": "2nd & 10",
        },
        {
            "file": "templates/raw_gameplay/3rd_3.png",
            "expected_down": 3,
            "is_goal": False,
            "description": "3rd & 3",
        },
        {
            "file": "templates/raw_gameplay/3rd_10.png",
            "expected_down": 3,
            "is_goal": False,
            "description": "3rd & 10",
        },
        {
            "file": "templates/raw_gameplay/4th_1.png",
            "expected_down": 4,
            "is_goal": False,
            "description": "4th & 1",
        },
        {
            "file": "templates/raw_gameplay/4th_10.png",
            "expected_down": 4,
            "is_goal": False,
            "description": "4th & 10",
        },
        {
            "file": "templates/raw_gameplay/3rd_goal.png",
            "expected_down": 3,
            "is_goal": True,
            "description": "3rd & Goal",
        },
        {
            "file": "templates/raw_gameplay/4th_goal.png",
            "expected_down": 4,
            "is_goal": True,
            "description": "4th & Goal",
        },
    ]
    ...
    for test_case in test_files:
        ...
        if result:
            ...
            print(
                f"   {'✅' if correct else '❌'} {test_case['description']}: "
...
def test_template_direct_matching():
    ...
    matches = detector._match_templates_with_context(preprocessed, (0, 0), is_goal_situation=False)
