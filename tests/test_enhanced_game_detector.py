...
class TestEnhancedGameDetection:
    ...
    def test_cross_game_conversion(self, enhanced_detector):
        ...
        madden_data = {
            ...
            "strategy": "Cover 2 Man"
        }
        
        universal_data = enhanced_detector.create_universal_data(
            madden_data, GameVersion.MADDEN_25
        )
        
        # Convert to CFB
        cfb_data = enhanced_detector.convert_to_target_game(
            universal_data, GameVersion.CFB_25
        )
