...
class ThemeManager:
    ...
    def apply_theme(self, theme_name: str, custom: bool = False) -> bool:
        """Apply a theme to the application.
        
        Args:
            theme_name: Name of the theme to apply
            custom: Whether this is a custom theme or Qt Material theme
    ...
    def get_available_themes(self, include_custom: bool = True) -> Dict[str, str]:
        ...
        themes = {
            name: 'material' 
            for name in self.material_themes.keys()
        }
        
        if include_custom:
            themes.update({
                name: 'custom'
                for name in self.custom_styles.keys()
            })
