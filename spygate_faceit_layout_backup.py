...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                            ...
                            QFrame, QGridLayout, QStackedWidget, QListWidget,
                            QListWidgetItem, QTextEdit, QProgressBar)
...
class SpygateDesktopFaceIt(QMainWindow):
    ...
    def create_premium_banner(self, parent_layout):
        ...
        upgrade_button.setStyleSheet(f"""
            QPushButton {{
    ...
    def create_game_area(self, parent_layout):
        ...
        analyze_button.setStyleSheet(f"""
            QPushButton {{
                background-color: transparent;
                color: #1ce783;
                font-size: 14px;
    ...
    def create_parties_section(self, parent_layout):
        ...
        party_count_small.setStyleSheet(f"""
            QLabel {{
                color: #767676;
                font-size: 12px;
                font-family: 'Minork Sans', Arial, sans-serif;
    ...
    def create_clubs_section(self, parent_layout):
        ...
        for club_name, member_count in club_items:
            ...
            club_name_label.setStyleSheet(f"""
                QLabel {{
                    color: #e3e3e3;
                    font-size: 13px;
                    font-weight: bold;
            ...
            club_members_label.setStyleSheet(f"""
                QLabel {{
                    color: #767676;
                    font-size: 11px;
                    font-family: 'Minork Sans', Arial, sans-serif;
