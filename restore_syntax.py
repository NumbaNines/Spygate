...
def restore_syntax():
    ...
    content = content.replace("'color: #767676; font-family: 'Segoe UI, sans-serif; font-size: 12px;)", 
                             '"color: #767676; font-family: \'Segoe UI\', sans-serif; font-size: 12px;"')
    
    content = content.replace("'color: #1ce783; font-family: 'Segoe UI, sans-serif; font-size: 28px; font-weight: bold;)", 
                             '"color: #1ce783; font-family: \'Segoe UI\', sans-serif; font-size: 28px; font-weight: bold;"')
    
    content = content.replace("'color: #767676; font-family: 'Segoe UI, sans-serif; font-size: 10px;)", 
                             '"color: #767676; font-family: \'Segoe UI\', sans-serif; font-size: 10px;"')
    
    # Fix docstring quotes
    content = content.replace("'Analysis Tab - Video processing and clip detection.'", 
                             '"Analysis Tab - Video processing and clip detection."')
    
    content = content.replace("'Represents a detected clip with metadata.''", 
    ...
    content = re.sub(r"setStyleSheet\('([^']*)$", r'setStyleSheet("""\1', content, flags=re.MULTILINE)
