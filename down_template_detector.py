...
class DownTemplateDetector:
    ...
    def _load_single_template(self, template_path: Path, situation_type: SituationType) -> None:
        ...
        try:
            ...
            logger.debug(f"Loaded template: {template_name} ({template_img.shape[1]}x{template_img.shape[0]})")
            ...
            for template_name, template_data in self.templates.items():
                ...
                for scale in self.SCALE_FACTORS:
                    scaled_matches = self._match_single_template_scaled(
                        preprocessed_roi, template_img, template_name, 
                        down, situation_type, scale, offset
                    )
    ...
    def _create_debug_visualization(
        ...
        try:
            ...
            cv2.putText(debug_frame, "YOLO: down_distance_area", (x1, y1-10), 
